...
const fields = [
  ...
  { key: 'goal_behavior', label: 'Goal Behavior', type: 'select', table: false, options: [{ label: 'Keep Under', value: 'keep_under' }, { label: 'Spend Exactly', value: 'spend_exactly' }, { label: 'Save At Least', value: 'save_at_least' }, { label: 'Track Only', value: 'track_only' }] },
